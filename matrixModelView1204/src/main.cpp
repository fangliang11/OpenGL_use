...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR cmdArgs, int cmdShow)
{
    ...
    Win::Window mainWin(hInst, L"三维点云图生成软件", 0, &mainCtrl);
    ...
    // send window handles to mainCtrl, so we can resize the child windows when main window resized主窗口大小调整则子窗口调整
