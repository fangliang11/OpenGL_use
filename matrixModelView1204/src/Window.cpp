                   ...
                   parentHandle(hParent), menuHandle(0)
{
    ...
    winClass.hIcon         = LoadIcon(instance, IDI_APPLICATION);   // default icon更改图标
    winClass.hIconSm       = 0;
...
///////////////////////////////////////////////////////////////////////////////
// show the window on the screen 显示窗口
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// load an icon using resource ID and convert it to HICON   加载图标
///////////////////////////////////////////////////////////////////////////////
