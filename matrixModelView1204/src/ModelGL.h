...
const int modelrow_MAX = 24645;
const int modelcolumn_MAX = 13;
extern float arry[modelrow_MAX][modelcolumn_MAX];
extern float arryX[modelrow_MAX];
extern float arryY[modelrow_MAX];
extern float arryZ[modelrow_MAX];
...
extern int readFiles(int AXES_LEN);
